    ...
    <>
      ...
      <section className="relative">
        <div className="overflow-hidden flex after:content[''] after:dark:from-brand-dark after:to-transparent after:from-background after:bg-gradient-to-l after:right-0 after:bottom-0 after:top-0 after:w-20 after:z-10 after:absolute before:content[''] before:dark:from-brand-dark before:to-transparent before:from-background before:bg-gradient-to-r before:left-0 before:top-0 before:bottom-0 before:w-20 before:z-10 before:absolute">
          {[...Array(2)].map((_, index) => (
            <div key={`carousel-${index}`} className="flex flex-nowrap animate-slide">
              {CLIENTS.map((client) => (
      ...
      <section className="relative">
        ...
        <div className="mt-20 px-4 sm:px-6 flex flex-col overflow-x-hidden overflow-visible">
          <TitleSection
            ...
            subheading="Join thousands of satisfied users who rely on our platform for their productivity needs."
            pill="Testimonials"
          />
          {[...Array(2)].map((_, index) => (
            <div
                ...
                <CustomCard
                  ...
                  cardHeader={
                    <div className="flex items-center gap-4">
                      <Avatar>
                        <AvatarImage src={`/avatars/${tIndex + 1}.png`} />
      ...
      <section className="mt-20 px-4 sm:px-6">
        <TitleSection
          ...
          subheading="Experience all the benefits of our platform. Select a plan that suits your needs."
          pill="Pricing"
        />
